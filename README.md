# ffmpeg-real-time-overlay-engine
...
## Setup
```bash
cd ffmpeg-real-time-overlay-engine
...
### Example
```bash
docker compose run --rm ffmpeg-tool python app.py /data/input/source.mp4 /data/output/overlay.mp4 --text 'LIVE'
```
